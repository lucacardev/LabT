...
public class OrganigramTenTechnicians extends JPanel {
    ...
    public OrganigramTenTechnicians (Controller controller,Responsabile loggedInManager,List<Tecnico> tecnici, Team t) {
        ...
        modifyButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(OrganigramTenTechnicians.this);
