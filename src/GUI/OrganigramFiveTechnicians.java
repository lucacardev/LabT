...
public class OrganigramFiveTechnicians extends JPanel {
    ...
    public OrganigramFiveTechnicians(Controller controller,Responsabile loggedInManager,List<Tecnico> Tecnici, Team t) {
        ...
        modifyButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                MainWindow mainWindow = (MainWindow) SwingUtilities.getWindowAncestor(OrganigramFiveTechnicians.this);
